...
def test_swan_5():
    '''Test reading of swan table'''
    ow_tab = ow.from_swantable('data/swan/TBL2.tbl')
    assert_equal(ow_tab.shape, (8,))


def test_swan_6():
    '''Test reading of instationary swan table'''
    ow_tab = ow.from_swantable('data/swan/TBL2NS.tbl')
...
def test_swan_7():
    ...
    ow_sp1_1 = ow.from_swan(fname1)
    ow_sp1_1.to_swan(fname2)
    ow_sp1_2 = ow.from_swan(fname2)
...
def test_swan_8():
    ...
    ow_sp2_1 = ow.from_swan(fname1)
    ow_sp2_1.to_swan(fname2)
    ow_sp2_2 = ow.from_swan(fname2)
